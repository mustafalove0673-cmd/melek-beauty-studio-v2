# @selahattin.unlu INSTAGRAM REELS - GITHUB REPO KATALOĞU

> **Kaynak:** https://www.instagram.com/selahattin.unlu
> **Toplam Reel Sayısı:** 103 reel, ~82 tanesi GitHub repo içerikli
...
## 📌 REPO LİSTESİ (Kategorilere Göre)
...
## 📋 SELAHATTİN ÜNLÜ HAKKINDA

- **Instagram:** @selahattin.unlu (342 following, 99 posts)
- **GitHub:** github.com/selahattinunlu (45 repos, 3 public)
- **YouTube:** Selahattin Ünlü (@selahattinunlu)
...
## 💡 CLAUDE CODE TEMEL İPUÇLARI (@selahattin.unlu)
...
| **Sosyal Medya Aracı** | postiz-app, htmx, strapi, chatwoot |
| **Eğitim Platformu** | forem, strapi, htmx, animate.css |
| **E-ticaret** | shadcn/ui, strapi, recharts, nocodb |
| **3D/Mimari** | three.js, pascalorg/editor |
| **Video/Medya** | remotion, ComfyUI, openscreen, heartlib |
| **Portfolio** | three.js, react-bits, framer/motion, animate.css |
| **Müzik/Audio** | sonic-pi, yt-music-cli, heartlib |
| **Fotoğraf/Medya** | immich, memos |
